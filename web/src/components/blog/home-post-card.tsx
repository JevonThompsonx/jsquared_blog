    ...
    return (
      <div className={`${gridClass} group relative`}>
        ...
        <article className="card-overlay relative block h-full min-h-[22rem] overflow-hidden rounded-lg shadow-lg sm:min-h-[24rem]" data-overlay-density={overlayDensity}>
          <Image alt={post.title} className="object-cover transition-transform duration-500 ease-in-out group-hover:scale-105" fill loading="lazy" src={image} sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 25vw" />
    ...
    return (
      <div className={`${gridClass} group relative`}>
        ...
        <article className="post-card-shell relative flex h-full flex-col overflow-hidden rounded-lg border shadow-lg transition-all duration-300 md:flex-row">
          ...
          <div className="relative h-64 overflow-hidden md:h-auto md:min-h-[240px] md:w-1/2">
            <Image alt={post.title} className="object-cover transition-transform duration-300 group-hover:scale-105" fill loading="lazy" src={image} sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
    ...
    <div className={`${gridClass} group relative`}>
      ...
      <article className="post-card-shell relative flex h-full flex-col overflow-hidden rounded-lg border shadow-lg transition-all duration-300">
        ...
        <div className="relative h-56 overflow-hidden sm:h-60">
          <Image alt={post.title} className="object-cover transition-transform duration-300 group-hover:scale-105" fill loading="lazy" src={image} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, (max-width: 1280px) 33vw, 25vw" />
        </div>
