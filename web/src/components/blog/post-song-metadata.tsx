...
export function PostSongMetadata({ song }: { song: BlogSongMetadata | null }) {
  ...
  if (spotifyEmbed) {
    return (
      <section className="mx-auto mb-8 max-w-[68ch] rounded-2xl border border-[var(--border)] bg-[var(--accent-soft)]/40 px-4 py-4 sm:px-5">
        <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-[var(--accent)]">Vibes for this story</p>
        {hasDisplayMetadata ? (
          <div className="mb-3">
  ...
  return (
    <section className="mx-auto mb-8 max-w-[68ch] rounded-2xl border border-[var(--border)] bg-[var(--accent-soft)]/40 px-4 py-4 sm:px-5">
      <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--accent)]">Vibes for this story</p>
