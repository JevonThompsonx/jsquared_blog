// Smoke-test runbook: docs/runbooks/comment-notifications-smoke.md
// (moved from inline steps to keep this service focused)
...
function getNotificationRecipient(): string | null {
  ...
  const parsedRecipient =
    commentNotificationRecipientSchema.safeParse(recipient);
...
export function buildCommentNotificationPayload(
  comment: CommentNotificationRecord,
